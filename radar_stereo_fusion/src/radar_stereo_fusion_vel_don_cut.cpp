...
void callback(const PointCloud::ConstPtr& msg) {
    ...
    for (int j = 0; j < radarDataArray_->obstacle.size(); j++) {
        if (radarDataArray_->obstacle[j].pose.position.x != 0 and radarDataArray_->obstacle[j].pose.position.y != 0) {
            ...
            cv::Matx41d p2((radar_point2.point.x), (radar_point2.point.y), (radar_point2.point.z), 1);
            ...
            cv::Point3d pt_cv5(radar_point2.point.x + 2.03, radar_point2.point.y /*- 1.0*/, radar_point2.point.z); //////////velodyne
            //            msg_radar_to_stereo->points.push_back(pcl::PointXYZ(pt_cv5.x, pt_cv5.y, pt_cv5.z));
                        msg_radar_to_stereo->points.push_back(pcl::PointXYZ(pt_cv5.x, pt_cv5.y, pt_cv5.z)); //////////velodyne
            ...
            if (pt_cv5.y > limts_x_min and pt_cv5.y < limts_x_max and //////////velodyne
                ...
                //                //    pcl::PassThrough<pcl::PointXYZA> pass;
